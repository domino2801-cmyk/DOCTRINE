...
- les icônes locales (`favicon.ico`, `android-icon-144x144.png`, `android-icon-192x192.png`, `apple-icon-144x144.png`, `apple-icon-152x152.png`, `icon-512.png`, `icon-maskable-512.png`) servent à l’onglet du navigateur, à l’installation PWA et au raccourci mobile
