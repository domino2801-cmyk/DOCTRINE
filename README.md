...
- le service worker `sw.js` met en cache dès l’installation le shell local (HTML, manifeste) et les icônes précachées (`icon.svg`, `favicon.ico`, `android-icon-144x144.png`, `android-icon-192x192.png`, `icon-512.png`, `icon-maskable-512.png`, `apple-icon.png`, `apple-icon-152x152.png`, `apple-icon-180x180.png`, `ms-icon-144x144.png`, `ms-icon-150x150.png`)
